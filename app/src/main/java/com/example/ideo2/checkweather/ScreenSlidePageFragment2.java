...
public class ScreenSlidePageFragment2 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        dayOfWeek.setText("Tommorow");
        weatherDesc.setText(descriptionArray.get(1));
        mornT.setText("Morning: "+(double)Math.round((tempMornArray.get(1)-273.15)*10d)/10d+" \u00B0C");
        dayT.setText((double)Math.round((tempDayArray.get(1)-273.15)*10d)/10d+" \u00B0C");
        nightT.setText("Night: "+(double)Math.round((tempNightArray.get(1)-273.15)*10d)/10d+" \u00B0C");
        pressureL.setText("Pressure: "+pressure.get(1)+" hPa");
        humidityL.setText("Humidity: "+humidity.get(1)+" %");

        if (mainArray.get(1).matches("Clear")) parentLayout.setBackgroundResource(R.drawable.clear_background);
        if (mainArray.get(1).matches("Rain")) parentLayout.setBackgroundResource(R.drawable.rain_background);
        if (mainArray.get(1).matches("Clouds")) parentLayout.setBackgroundResource(R.drawable.clouds_background);
        if (mainArray.get(1).matches("Snow")) parentLayout.setBackgroundResource(R.drawable.snow_background);
