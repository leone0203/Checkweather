...
public class ScreenSlidePageFragment6 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        weatherDesc.setText(descriptionArray.get(5));
        mornT.setText("Morning: "+(double)Math.round((tempMornArray.get(5)-273.15)*10d)/10d+" \u00B0C");
        dayT.setText((double)Math.round((tempDayArray.get(5)-273.15)*10d)/10d+" \u00B0C");
        nightT.setText("Night: "+(double)Math.round((tempNightArray.get(5)-273.15)*10d)/10d+" \u00B0C");
        pressureL.setText("Pressure: "+pressure.get(5)+" hPa");
        humidityL.setText("Humidity: "+humidity.get(5)+" %");
        ...
        if (mainArray.get(5).matches("Clear")) parentLayout.setBackgroundResource(R.drawable.clear_background);
        if (mainArray.get(5).matches("Rain")) parentLayout.setBackgroundResource(R.drawable.rain_background);
        if (mainArray.get(5).matches("Clouds")) parentLayout.setBackgroundResource(R.drawable.clouds_background);
        if (mainArray.get(5).matches("Snow")) parentLayout.setBackgroundResource(R.drawable.snow_background);
