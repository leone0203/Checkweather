...
public class ScreenSlidePageFragment4 extends android.support.v4.app.Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        weatherDesc.setText(descriptionArray.get(3));
        mornT.setText("Morning: "+(double)Math.round((tempMornArray.get(3)-273.15)*10d)/10d+" \u00B0C");
        dayT.setText((double)Math.round((tempDayArray.get(3)-273.15)*10d)/10d+" \u00B0C");
        nightT.setText("Night: "+(double)Math.round((tempNightArray.get(3)-273.15)*10d)/10d+" \u00B0C");
        pressureL.setText("Pressure: "+pressure.get(3)+" hPa");
        humidityL.setText("Humidity: "+humidity.get(3)+" %");
        ...
        switch (day) {
            ...
            default: {
                dayOfWeek.setText("Day4");
                break;
            }

        }

        if (mainArray.get(3).matches("Clear")) parentLayout.setBackgroundResource(R.drawable.clear_background);
        if (mainArray.get(3).matches("Rain")) parentLayout.setBackgroundResource(R.drawable.rain_background);
        if (mainArray.get(3).matches("Clouds")) parentLayout.setBackgroundResource(R.drawable.clouds_background);
        if (mainArray.get(3).matches("Snow")) parentLayout.setBackgroundResource(R.drawable.snow_background);
